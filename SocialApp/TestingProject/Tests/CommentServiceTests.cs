...
namespace TestingProject.Tests
{
    ...
    public class CommentServiceTests
    {
        ...
        public void AddComment_WithValidArguments_ReturnsComment()
        {
            ...
            var user = new User { Id = userId, Username = "TestUser", Password = "TestPassword", PhotoURL = "TestImage" };
            var post = new Post { Id = postId, Title = "TestPost", Content = "TestContent", CreatedDate = DateTime.Now, UserId = userId, GroupId = 1, Visibility = PostVisibility.Public, Tag = PostTag.Misc };
